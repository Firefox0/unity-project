...
public class ShopScene : MonoBehaviour {
    ...
    void Start() {
        this.health_button.onClick.AddListener(() => this.buy(ref health_text, ref PlayerData.secrets.health, 5));
        this.stamina_button.onClick.AddListener(() => this.buy(ref stamina_text, ref PlayerData.secrets.stamina, 5));
        this.walking_button.onClick.AddListener(() => this.buy(ref walking_text, ref PlayerData.secrets.walking_speed, 0.1f));
        this.running_button.onClick.AddListener(() => this.buy(ref running_text, ref PlayerData.secrets.running_speed, 0.1f));
        this.slow_button.onClick.AddListener(() => this.buy(ref slow_text, ref PlayerData.secrets.slow_resistance, 0.5f));
        this.stun_button.onClick.AddListener(() => this.buy(ref stun_text, ref PlayerData.secrets.stun_resistance, 0.5f));
    ...
    void buy(ref TextMeshProUGUI text_gui, ref float stat, float upgrade) {
